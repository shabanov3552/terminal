...
if (document.querySelector('.popular__slider1')) {
	new Swiper('.popular__slider1', {
		speed: 800,
		navigation: {
			nextEl: ".popular__nav-next1",
			prevEl: ".popular__nav-prev1",
		},
		breakpoints: {
			320: {
				slidesPerView: 1,
...
if (document.querySelector('.popular__slider2')) {
	new Swiper('.popular__slider2', {
		speed: 800,
		navigation: {
			nextEl: ".popular__nav-next2",
			prevEl: ".popular__nav-prev2",
		},
		breakpoints: {
			320: {
				slidesPerView: 1,
...
if (document.querySelector('.popular__slider3')) {
	new Swiper('.popular__slider3', {
		speed: 800,
		navigation: {
			nextEl: ".popular__nav-next3",
			prevEl: ".popular__nav-prev3",
		},
		breakpoints: {
			320: {
				slidesPerView: 1,
...
if (document.querySelector('.article__row')) {
	new Swiper('.article__row', {
		autoplay: true,
		speed: 800,
		breakpoints: {
			320: {
...
//#region Menu_burger
let catalog__btn = document.querySelector('.catalog-btn');
let modal_catalog = document.querySelector(".modal-catalog");
...
document.addEventListener('keydown', function (e) {
	if (e.code === 'Escape') {
		popup_close();
		if (modal_catalog.classList.contains('_active')) {
			body_lock();
			modal_catalog.classList.remove("_active");
		}
	}
...
function mapAdd() {
	...
	tag.src = "https://maps.googleapis.com/maps/api/js?&callback=mapInit";
...
function mapInit(n = 1) {
	...
	var locations = [
		[new google.maps.LatLng(56.015904, 93.013744)],
		[new google.maps.LatLng(56.021813, 93.051329)],
	]
	var options = {
		zoom: 14,
		panControl: false,
		...
		zoomControl: true,
		scrollwheel: false,
		center: new google.maps.LatLng(56.019049, 93.034643),
...
$('.category__link').hover(function () {
	$(this)
		.addClass('_active').siblings().removeClass('_active')
		.closest('div.category__wrapper').find('div.category__video').removeClass('_active').eq($(this).index()).addClass('_active');
});

//#endregion

//#region Показать больше

const btn_more = document.querySelectorAll('.parametrs__btn-more');
...
btn_more.forEach(element => {
	element.addEventListener("click", function (e) {
		...
		if (!e.target.classList.contains('_active')) {
			element.innerHTML = 'раскрыть все';
		} else {
			element.innerHTML = 'скрыть все';
		}
	});
});
